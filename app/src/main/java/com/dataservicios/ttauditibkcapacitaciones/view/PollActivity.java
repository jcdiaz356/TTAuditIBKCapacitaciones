...
import com.dataservicios.ttauditibkcapacitaciones.db.DatabaseManager;
import com.dataservicios.ttauditibkcapacitaciones.model.AuditRoadStore;
import com.dataservicios.ttauditibkcapacitaciones.model.Company;
import com.dataservicios.ttauditibkcapacitaciones.model.Media;
import com.dataservicios.ttauditibkcapacitaciones.model.Poll;
import com.dataservicios.ttauditibkcapacitaciones.model.PollDetail;
import com.dataservicios.ttauditibkcapacitaciones.model.PollOption;
import com.dataservicios.ttauditibkcapacitaciones.model.Route;
import com.dataservicios.ttauditibkcapacitaciones.model.Store;
import com.dataservicios.ttauditibkcapacitaciones.repo.AuditRoadStoreRepo;
import com.dataservicios.ttauditibkcapacitaciones.repo.CompanyRepo;
import com.dataservicios.ttauditibkcapacitaciones.repo.PollOptionRepo;
import com.dataservicios.ttauditibkcapacitaciones.repo.PollRepo;
import com.dataservicios.ttauditibkcapacitaciones.repo.RouteRepo;
import com.dataservicios.ttauditibkcapacitaciones.repo.StoreRepo;
import com.dataservicios.ttauditibkcapacitaciones.util.AuditUtil;
import com.dataservicios.ttauditibkcapacitaciones.util.GPSTracker;
import com.dataservicios.ttauditibkcapacitaciones.util.SessionManager;
        ...
        switch (orderPoll) {
            ...
            case 3:
                swYesNo.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        if(isChecked) showCommentControl(false); else showCommentControl(true);
                    }
                });
                break;
            case 5:
            ...
            case 7:
                ...
                swYesNo.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        if(isChecked) showCommentControl(true); else showCommentControl(false);
                    }
                });
                break;
        }
